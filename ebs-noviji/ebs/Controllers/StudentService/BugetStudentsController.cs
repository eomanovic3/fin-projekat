...
{
    public class BugetStudentsController : Controller
    {
        static List<string> alldata = null;
        OracleDbConnection conn = new OracleDbConnection();

        // GET: AllStudents
        public ActionResult BugetStudents()
        {
            return View();
        }
        [HttpPost]
        public ActionResult BugetStudents(string xOsa, string yOsa)
        {
            TempData["xOsa"] = xOsa;
            TempData["yOsa"] = yOsa;
            return View();
